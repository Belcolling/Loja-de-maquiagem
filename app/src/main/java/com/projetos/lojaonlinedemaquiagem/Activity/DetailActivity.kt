...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.imageModel.observe(this, { imageModel ->
            binding.imageView3.setImageResource(imageModel.imageResId) // Define a imagem do produto.
            binding.makeName.text = imageModel.name // Define o nome do produto.
            binding.makePrice.text = imageModel.price // Define o preço do produto.
            binding.makeDescription.text =
                "Conheça nossa paleta de sombras repleta de cores vivas e brilhosas garantimos que você não vai se arrepender então já garanta há sua!" // Define a descrição fixa do produto.
        })
        ...
        val sizeButtons = listOf(
            binding.buttonSizegold,
            binding.buttonSizeprata,
            binding.buttonSizerose
        )
